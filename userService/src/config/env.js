...
const envSchema = z.object({
  ...
  PHONE_VERIFICATION_ENABLED: envBoolean().default(true),
  PHONE_VERIFICATION_CODE_TTL_SECONDS: z.coerce.number().int().positive().default(300),
  PHONE_VERIFICATION_RESEND_COOLDOWN_SECONDS: z.coerce.number().int().positive().default(60),
  PHONE_VERIFICATION_MAX_VERIFY_ATTEMPTS: z.coerce.number().int().positive().default(5),
  PHONE_VERIFICATION_SEND_MAX_PER_WINDOW: z.coerce.number().int().positive().default(5),
