...
process.env.PHONE_VERIFICATION_CODE_TTL_SECONDS = '300';
process.env.PHONE_VERIFICATION_RESEND_COOLDOWN_SECONDS = '60';
process.env.PHONE_VERIFICATION_MAX_VERIFY_ATTEMPTS = '5';
process.env.PHONE_VERIFICATION_SEND_MAX_PER_WINDOW = '1000';
process.env.PHONE_VERIFICATION_SEND_WINDOW_SECONDS = '3600';
process.env.PHONE_VERIFICATION_PHONE_MAX_PER_WINDOW = '1000';
process.env.PHONE_VERIFICATION_HASH_SECRET = '';
process.env.SMS_PROVIDER = 'noop';
process.env.SMS_FROM_PHONE = '+15550000000';
